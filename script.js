...
const commonPrefixes = [
    ...
    '迟钝的', '无用的', '快乐的', '旅行的',
    '任性的', '冲动的', '安静的', '憨厚的', '淡定的', '坚强的', '火爆的', '奔放的', '痴情的', '调皮的', '斯文的', '愉快的', '痛苦的', '烦恼的', '紧张的', '忧郁的', '焦虑的', '苦闷的', '着急的', '难过的', '无聊的', '孤独的', '时尚的', '飞翔的', '行走的', '奔跑的', '唠叨的', '迷茫的', '彷徨的', '忐忑的', '茫然的', '失落的', '阳光的', '绅士的', '礼貌的', '宽容的', '大气的', '爱笑的', '不羁的', '魁梧的', '睿智的', '深沉的', '稳重的', '豪爽的', '低调的', '正直的', '博学的', '儒雅的', '阳刚的', '慷慨的', '善良的', '心软的', '刚毅的', '严肃的', '成熟的', '坚韧的', '含蓄的', '强悍的', '强健的', '踏实的', '体贴的', '细心的', '个性的', '另类的', '纯真的', '叛逆的', '英俊的', '风流的', '风流倜傥的', '玉树临风的', '神勇威武的', '文武双全的', '侠义非凡的', '谦虚好学的', '聪明伶俐的', '有情有义的', '有胆有识的', '谈吐大方的', '风度翩翩的', '气势凌人的', '文质彬彬的', '面冷心慈的', '豪情万千的', '温文尔雅的', '年轻有为的',
    '短小精悍', '朴素', '整洁', '时髦', '摩登', '讲究', '笔挺', '邋遢', '俗气', '穿戴整齐', '衣冠楚楚', '珠光宝气', '花枝招展', '衣衫不整', '庄重', '端庄', '安闲', '安详', '恬静', '镇静', '沉着', '诚挚', '恳切', '妩媚', '羞涩', '腼腆', '严厉', '冷酷', '傲慢', '疲惫', '沮丧', '失神', '诧异', '发愣', '尴尬', '踌躇', '容光焕发', '英姿勃勃', '精神矍铄', '精神抖擞', '生龙活虎', '津津有味', '若无其事', '不露声色', '面红耳赤', '面有赧颜', '无精打彩', '郁郁寡欢', '闷闷不乐', '局促不安', '垂头丧气', '精疲力竭', '风尘仆仆', '气喘吁吁', '呆若木鸡', '瞠目结舌', '哑口无言', '交头接耳', '笨头笨脑', '疯疯癫癫', '凶神恶煞', '杀气腾腾', '装腔作势', '盛气凌人', '龇牙咧嘴', '神气十足', '傲慢无礼', '神气活现', '趾高气扬', '咄咄逼人', '目空一切', '不屑一顾', '目中无人', '旁若无人', '冷眼旁观', '贼头贼脑', '鬼鬼祟祟', '半信半疑', '不知所措', '漫不经心', '心不在焉', '怅然若失', '垂涎三尺', '死皮赖脸', '缩手缩脚', '丑态百出'
];
